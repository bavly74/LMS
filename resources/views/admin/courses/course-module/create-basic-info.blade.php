@extends('admin.courses.course-module.course-app')
@section('tab_content')
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="add_course_basic_info_imput">
                            ...
                            <select class="select_js demo_video_storage form-control" name="demo_video_storage">
                    ...
                    <div class="col-xl-6">
                        ...
                        <div class="input-group video_source_input mt-2">
                            ...
                            <input id="thumbnail" class="form-control demo_video_source" type="text"
                                name="demo_video_source">
                        </div>

                        <!-- إدخال رابط -->
                        <div class="input-group video_text_input mt-2 d-none">
                            <input type="text" class="form-control demo_video_source" name="url"
